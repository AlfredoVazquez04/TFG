...
class NormalizedDataset:
    ...
    def __call__(self, src_path, tgt_path, train_percentage):
        ...
        name_list_ext_va = os.listdir(src_path + "/imagesVa")

        self.img_names_list = name_list_ext_tr + name_list_ext_va
        ...
        for path_img_va in name_list_ext_va:
            self.path_img_list[path_img_va] = src_path+"/imagesVa/"+path_img_va
            path_lbl_va = path_img_va.replace("img", "label")
            self.path_label_list[path_lbl_va] = src_path+"/labelsVa/"+ path_lbl_va
    ...
    def __apply_transformations(self, data, tgt_path):
        ...
        for img_name in data:
            ...
            transformation = self.transformations(pixdim=(1.5, 1.5, 1.5))
...
if __name__ == "__main__":
    ...
    src_path = load_from_file(config['amos']['3D']['src_path'])
    tgt_path = load_from_file(config["amos"]["3D"]["dst_path"])
    train_percentage = float(config["amos"]["3D"]["train_percentage"])
